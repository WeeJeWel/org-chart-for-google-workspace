...
const buildEmail = (first: string, last: string) => `${first}.${last}`.toLowerCase() + '@example.com';

export const createSampleDirectory = (): DirectoryPerson[] => {
